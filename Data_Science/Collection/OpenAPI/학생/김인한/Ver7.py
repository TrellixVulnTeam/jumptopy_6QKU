...
# 적정 습도 g_Min_Acceptable_humidity_level, 60을 변수 처리 할것

# 인공지능 모드인 상태에서 45분이 되었을때 실시간 정보를 가져올 경우
# 장비를 변경할 수 있는 조건인 경우 장비를 변경한다.
# 마찬가지로 인공지능 모드인 상태에서 실시간 정보를 업데이트 했을때
# 장비를 변경할 수 있는 조건이라면 장비를 변경한다
