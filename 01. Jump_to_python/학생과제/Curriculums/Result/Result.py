...
\\Academies.bin", 'rb')
            file_copy = open("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\
...
\\Academies.bin")
                os.rename("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\
\\Academies_copy.bin", "D:\Python_workspace\jumptopy\Jump_to_python\학생과제\
\\Academies.bin")
                break
    elif order_1 == "1" :
