...
class curriculums() :
    def search_curriculum_info(self):
        ...
        # os.chdir("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\Academies")
        listdir_name = os.listdir("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\\\Academies")

        if order == '1' :
            for x in listdir_name :
                for y in os.listdir("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\
\\Academies\\"+x) :
                    file = open("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\\\Academies\
\\"+x+"\\"+y,'rb')
                    try :
...
\\Managing_Academies\\Academies\\"+x)
            ...
            for x in listdir_name :
                try :
                    file = open("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\
\\Academies\\"+x+"\\"+search_curriculum_name+".bin", 'rb')
            ...
            try :
                ...
                os.unlink("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\
