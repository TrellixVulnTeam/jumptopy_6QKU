...
class academies() :
    def serch_academy_info(self):
        ...
        print()
        try :
            file = open("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\\Academies.bin", 'rb')
        ...
        if order == '1' :
            ...
            try :
                os.rmdir("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\\Academies\\"+delet_dir_name)
    ...
    def make_academy(self, instance) :
        try :
            if instance.name != "!@#$" :
                os.mkdir("D:\Python_workspace\jumptopy\Jump_to_python\학생과제\\Academies\\"+instance.name)
