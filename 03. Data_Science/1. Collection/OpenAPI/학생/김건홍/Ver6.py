...
# 4. 실시간 기상정보 Update 불러오기 => 에러 해결
# http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastTimeData?base_dat여 제습기/가습기를 제어 할것e=20180201&base_time=1356&nx=89&ny=91&_type=json&serviceKey=zKXKKnSlFbzQlSo3VGM7RSWUTndjwM0szSJhbK%2F85hKnvtPxU6zBzaudnzPFNNHf5j1azPl%2B7p4IfYMW8%2Bi4lg%3D%3D&pageNo=2
# 실시간 업데이트시 REH 값을 활용하여 적정 습도와 비교하
#HK Comment] 가스밸브 열림/닫힘으로 표시
